...
import src.com.backend.parcial.dao.H2Connection;
...
public class OdontologoDaoH2 implements IDao<Odontologo> {
    ...
    public Odontologo registrar(Odontologo odontologo) {
        ...
        try {
            ...
            while (resultSet.next()){
                odontologoRegistrado = new Odontologo(resultSet.getInt("id"), odontologo.getNumeroMatricula(), odontologo.getNombre(), odontologo.getApellido());
    ...
    public List<Odontologo> listarTodos() {
        ...
        try{
            ...
            while (resultSet.next()){
                Odontologo odontologo = crearObjetoOdongologo(resultSet);
                odontologos.add(odontologo);
            }

            LOGGER.info("Listado de odontologos registrados: " + odontologos);
    ...
    private Odontologo crearObjetoOdongologo(ResultSet rs) throws SQLException{
        int id = rs.getInt("id");
